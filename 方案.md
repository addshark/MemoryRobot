...
/usr/local/include/dlib/face_recognition/face_recognition_model_v1.h:61:45: error: ‘to_grayscale’ is not a member of ‘dlib’
   61 |             return (*this)(dlib::mean(dlib::to_grayscale<dlib::rgb_pixel>(face_img) ));
      |                                             ^~~~~~~~~~~~
/usr/local/include/dlib/face_recognition/face_recognition_model_v1.h:61:73: error: expected primary-expression before ‘>’ token
   61 |             return (*this)(dlib::mean(dlib::to_grayscale<dlib::rgb_pixel>(face_img) ));
      |                                                                         ^
/usr/local/include/dlib/face_recognition/face_recognition_model_v1.h:71:54: error: ‘to_grayscale’ is not a member of ‘dlib’
   71 |                     desc += (*this)(dlib::mean(dlib::to_grayscale(temp)));
      |                                                      ^~~~~~~~~~~~
/usr/local/include/dlib/face_recognition/face_recognition_model_v1.h: In member function ‘dlib::chip_details face_recognition_model_v1::get_face_chip_details(const dlib::full_object_detection&, int, T, const dlib::vector<T, 2>&) const’:
/usr/local/include/dlib/face_recognition/face_recognition_model_v1.h:107:48: error: ‘const dlib::point’ {aka ‘const class dlib::vector<long int, 2>’} has no member named ‘cast’; did you mean ‘cost’?
  107 |     dlib::vector<T, 2> center = (r.tl_corner().cast<T>() + r.br_corner().cast<T>()) / T(2.0);
      |                                                ^~~~
      |                                                cost
/usr/local/include/dlib/face_recognition/face_recognition_model_v1.h:107:54: error: expected primary-expression before ‘>’ token
  107 |     dlib::vector<T, 2> center = (r.tl_corner().cast<T>() + r.br_corner().cast<T>()) / T(2.0);
      |                                                      ^
/usr/local/include/dlib/face_recognition/face_recognition_model_v1.h:107:56: error: expected primary-expression before ‘)’ token
  107 |     dlib::vector<T, 2> center = (r.tl_corner().cast<T>() + r.br_corner().cast<T>()) / T(2.0);
      |                                                        ^
/usr/local/include/dlib/face_recognition/face_recognition_model_v1.h:107:74: error: ‘const dlib::point’ {aka ‘const class dlib::vector<long int, 2>’} has no member named ‘cast’; did you mean ‘cost’?
  107 |     dlib::vector<T, 2> center = (r.tl_corner().cast<T>() + r.br_corner().cast<T>()) / T(2.0);
      |                                                                          ^~~~
      |                                                                          cost
/usr/local/include/dlib/face_recognition/face_recognition_model_v1.h:107:80: error: expected primary-expression before ‘>’ token
  107 |     dlib::vector<T, 2> center = (r.tl_corner().cast<T>() + r.br_corner().cast<T>()) / T(2.0);
      |                                                                                ^
/usr/local/include/dlib/face_recognition/face_recognition_model_v1.h:107:82: error: expected primary-expression before ‘)’ token
  107 |     dlib::vector<T, 2> center = (r.tl_corner().cast<T>() + r.br_corner().cast<T>()) / T(2.0);
      |                                                                                  ^
vision_module.cpp: In member function ‘std::string VisionModule::getFaceFeature()’:
vision_module.cpp:101:48: error: ‘cv_mat’ was not declared in this scope; did you mean ‘cvMat’?
  101 |     dlib::cv_image<dlib::bgr_pixel> dlib_frame(cv_mat);  // cv_mat是OpenCV的Mat
      |                                                ^~~~~~
      |                                                cvMat
/usr/local/include/dlib/face_recognition/face_recognition_model_v1.h: In instantiation of ‘dlib::matrix<float, 0, 1> face_recognition_model_v1::compute_face_descriptor(const dlib::matrix<T, 0, 0, dlib::memory_manager_stateless_kernel_1<char>, dlib::row_major_layout>&, const dlib::full_object_detection&, int) const [with T = dlib::bgr_pixel]’:
vision_module.cpp:115:87:   required from here
/usr/local/include/dlib/face_recognition/face_recognition_model_v1.h:70:99: error: no matching function for call to ‘dlib::vector<double, 3>::vector(int, int)’
   70 |                     extract_image_chip(img, get_face_chip_details<double>(shape, 150, 0.25, dlib::vector<double,3>(i-num_jitters/2, j-num_jitters/2)), temp);
      |                                                                                                   ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
In file included from /usr/local/include/dlib/geometry/rectangle.h:11,
                 from /usr/local/include/dlib/array2d/array2d_kernel.h:10,
                 from /usr/local/include/dlib/array2d.h:7,
                 from /usr/local/include/dlib/matrix/matrix_mat.h:10,
                 from /usr/local/include/dlib/opencv/cv_image.h:11,
                 from /usr/local/include/dlib/opencv.h:10,
                 from vision_module.h:5:
/usr/local/include/dlib/geometry/vector.h:289:9: note: candidate: ‘template<class EXP> dlib::vector<T, 3>::vector(const dlib::matrix_exp<U>&) [with T = double]’
  289 |         vector ( const matrix_exp<EXP>& m)
      |         ^~~~~~
/usr/local/include/dlib/geometry/vector.h:289:9: note:   template argument deduction/substitution failed:
/usr/local/include/dlib/face_recognition/face_recognition_model_v1.h:70:99: note:   mismatched types ‘const dlib::matrix_exp<EXP>’ and ‘int’
   70 |                     extract_image_chip(img, get_face_chip_details<double>(shape, 150, 0.25, dlib::vector<double,3>(i-num_jitters/2, j-num_jitters/2)), temp);
      |                                                                                                   ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
/usr/local/include/dlib/geometry/vector.h:279:9: note: candidate: ‘template<class U> dlib::vector<T, 3>::vector(const dlib::vector<U, 3>&) [with T = double]’
  279 |         vector (
      |         ^~~~~~
/usr/local/include/dlib/geometry/vector.h:279:9: note:   template argument deduction/substitution failed:
/usr/local/include/dlib/face_recognition/face_recognition_model_v1.h:70:99: note:   mismatched types ‘const dlib::vector<T, 3>’ and ‘int’
   70 |                     extract_image_chip(img, get_face_chip_details<double>(shape, 150, 0.25, dlib::vector<double,3>(i-num_jitters/2, j-num_jitters/2)), temp);
      |                                                                                                   ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
/usr/local/include/dlib/geometry/vector.h:253:9: note: candidate: ‘template<class U> dlib::vector<T, 3>::vector(const dlib::vector<U, 2>&) [with T = double]’
  253 |         vector (
      |         ^~~~~~
/usr/local/include/dlib/geometry/vector.h:253:9: note:   template argument deduction/substitution failed:
/usr/local/include/dlib/face_recognition/face_recognition_model_v1.h:70:99: note:   mismatched types ‘const dlib::vector<T, 2>’ and ‘int’
   70 |                     extract_image_chip(img, get_face_chip_details<double>(shape, 150, 0.25, dlib::vector<double,3>(i-num_jitters/2, j-num_jitters/2)), temp);
      |                                                                                                   ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
/usr/local/include/dlib/geometry/vector.h:267:9: note: candidate: ‘dlib::vector<T, 3>::vector(const dlib::vector<T, 2>&) [with T = double]’
  267 |         vector (
      |         ^~~~~~
/usr/local/include/dlib/geometry/vector.h:267:9: note:   candidate expects 1 argument, 2 provided
/usr/local/include/dlib/geometry/vector.h:244:9: note: candidate: ‘dlib::vector<T, 3>::vector(const dlib::vector<T, 3>&) [with T = double]’
  244 |         vector (
      |         ^~~~~~
/usr/local/include/dlib/geometry/vector.h:244:9: note:   candidate expects 1 argument, 2 provided
/usr/local/include/dlib/geometry/vector.h:231:9: note: candidate: ‘dlib::vector<T, 3>::vector(T, T, T) [with T = double]’
  231 |         vector (
      |         ^~~~~~
/usr/local/include/dlib/geometry/vector.h:231:9: note:   candidate expects 3 arguments, 2 provided
/usr/local/include/dlib/geometry/vector.h:221:9: note: candidate: ‘dlib::vector<T, 3>::vector() [with T = double]’
  221 |         vector (
      |         ^~~~~~
/usr/local/include/dlib/geometry/vector.h:221:9: note:   candidate expects 0 arguments, 2 provided
In file included from /usr/local/include/dlib/algs.h:116,
                 from /usr/local/include/dlib/opencv/cv_image.h:9:
/usr/local/include/dlib/matrix/matrix.h: In instantiation of ‘dlib::matrix<T, num_rows, num_cols, mem_manager, layout>::operator const type() const [with T = double; long int num_rows = 2; long int num_cols = 1; mem_manager = dlib::memory_manager_stateless_kernel_1<char>; layout = dlib::row_major_layout; type = double]’:
/usr/local/include/dlib/face_recognition/face_recognition_model_v1.h:116:18:   required from ‘dlib::chip_details face_recognition_model_v1::get_face_chip_details(const dlib::full_object_detection&, int, T, const dlib::vector<T, 2>&) const [with T = double]’
/usr/local/include/dlib/face_recognition/face_recognition_model_v1.h:58:62:   required from ‘dlib::matrix<float, 0, 1> face_recognition_model_v1::compute_face_descriptor(const dlib::matrix<T, 0, 0, dlib::memory_manager_stateless_kernel_1<char>, dlib::row_major_layout>&, const dlib::full_object_detection&, int) const [with T = dlib::bgr_pixel]’
vision_module.cpp:115:87:   required from here
/usr/local/include/dlib/matrix/matrix.h:1342:13: error: static assertion failed: Failed assertion
 1342 |             COMPILE_TIME_ASSERT(NR == 1 || NR == 0);
      |             ^~~~~~~~~~~~~~~~~~~
/usr/local/include/dlib/matrix/matrix.h:1342:13: note: ‘((((long int)dlib::matrix<double, 2, 1, dlib::memory_manager_stateless_kernel_1<char>, dlib::row_major_layout>::NR) == 1) || (((long int)dlib::matrix<double, 2, 1, dlib::memory_manager_stateless_kernel_1<char>, dlib::row_major_layout>::NR) == 0))’ evaluates to false