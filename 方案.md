...
In file included from vision_module.cpp:1:
vision_module.h:17:10: fatal error: dlib/color_space.h: No such file or directory
   17 | #include <dlib/color_space.h>
      |          ^~~~~~~~~~~~~~~~~~~~
compilation terminated.
addshark@addshark-desktop:~/Desktop/addshark/MemoryRobot$ g++ -o test_vision vision_module.cpp $(pkg-config --cflags --libs opencv4) -ldlib -Wall -I.
...
/usr/local/include/dlib/statistics/lda.h:199:5: note: parameter passing for argument of type ‘std::pair<double, double>’ when C++17 is enabled changed to match C++14 in GCC 10.1
  199 |     )
      |     ^
In file included from vision_module.h:21:
face_recognition_model_v1.h: In member function ‘dlib::matrix<float, 0, 1> face_recognition_model_v1::compute_face_descriptor(const dlib::matrix<T, 0, 0, dlib::memory_manager_stateless_kernel_1<char>, dlib::row_major_layout>&, const dlib::full_object_detection&, int) const’:
face_recognition_model_v1.h:61:45: error: ‘to_grayscale’ is not a member of ‘dlib’
   61 |             return (*this)(dlib::mean(dlib::to_grayscale<dlib::rgb_pixel>(face_img) ));
      |                                             ^~~~~~~~~~~~
face_recognition_model_v1.h:61:73: error: expected primary-expression before ‘>’ token
   61 |             return (*this)(dlib::mean(dlib::to_grayscale<dlib::rgb_pixel>(face_img) ));
      |                                                                         ^
face_recognition_model_v1.h:71:54: error: ‘to_grayscale’ is not a member of ‘dlib’
   71 |                     desc += (*this)(dlib::mean(dlib::to_grayscale(temp)));
      |                                                      ^~~~~~~~~~~~
face_recognition_model_v1.h: In member function ‘dlib::chip_details face_recognition_model_v1::get_face_chip_details(const dlib::full_object_detection&, int, T, const dlib::vector<T, 2>&) const’:
face_recognition_model_v1.h:107:48: error: ‘const dlib::point’ {aka ‘const class dlib::vector<long int, 2>’} has no member named ‘cast’; did you mean ‘cost’?
  107 |     dlib::vector<T, 2> center = (r.tl_corner().cast<T>() + r.br_corner().cast<T>()) / T(2.0);
      |                                                ^~~~
      |                                                cost
face_recognition_model_v1.h:107:54: error: expected primary-expression before ‘>’ token
  107 |     dlib::vector<T, 2> center = (r.tl_corner().cast<T>() + r.br_corner().cast<T>()) / T(2.0);
      |                                                      ^
face_recognition_model_v1.h:107:56: error: expected primary-expression before ‘)’ token
  107 |     dlib::vector<T, 2> center = (r.tl_corner().cast<T>() + r.br_corner().cast<T>()) / T(2.0);
      |                                                        ^
face_recognition_model_v1.h:107:74: error: ‘const dlib::point’ {aka ‘const class dlib::vector<long int, 2>’} has no member named ‘cast’; did you mean ‘cost’?
  107 |     dlib::vector<T, 2> center = (r.tl_corner().cast<T>() + r.br_corner().cast<T>()) / T(2.0);
      |                                                                          ^~~~
      |                                                                          cost
face_recognition_model_v1.h:107:80: error: expected primary-expression before ‘>’ token
  107 |     dlib::vector<T, 2> center = (r.tl_corner().cast<T>() + r.br_corner().cast<T>()) / T(2.0);
      |                                                                                ^
face_recognition_model_v1.h:107:82: error: expected primary-expression before ‘)’ token
  107 |     dlib::vector<T, 2> center = (r.tl_corner().cast<T>() + r.br_corner().cast<T>()) / T(2.0);
      |                                                                                  ^
vision_module.cpp: In member function ‘std::string VisionModule::getFaceFeature()’:
vision_module.cpp:111:87: error: no matching function for call to ‘face_recognition_model_v1::compute_face_descriptor(dlib::cv_image<dlib::bgr_pixel>&, dlib::full_object_detection&, int)’
  111 |     dlib::matrix<float, 0, 1> face_descriptor = face_rec_model.compute_face_descriptor(dlib_frame, shape, 1);
      |                                                 ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~^~~~~~~~~~~~~~~~~~~~~~
face_recognition_model_v1.h:51:31: note: candidate: ‘template<class T> dlib::matrix<float, 0, 1> face_recognition_model_v1::compute_face_descriptor(const dlib::matrix<T, 0, 0, dlib::memory_manager_stateless_kernel_1<char>, dlib::row_major_layout>&, const dlib::full_object_detection&, int) const’
   51 |     dlib::matrix<float, 0, 1> compute_face_descriptor(
      |                               ^~~~~~~~~~~~~~~~~~~~~~~
face_recognition_model_v1.h:51:31: note:   template argument deduction/substitution failed:
vision_module.cpp:111:87: note:   ‘dlib::cv_image<dlib::bgr_pixel>’ is not derived from ‘const dlib::matrix<T, 0, 0, dlib::memory_manager_stateless_kernel_1<char>, dlib::row_major_layout>’
  111 |     dlib::matrix<float, 0, 1> face_descriptor = face_rec_model.compute_face_descriptor(dlib_frame, shape, 1);
      |                                                 ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~^~~~~~~~~~~~~~~~~~~~~~
face_recognition_model_v1.h:81:44: note: candidate: ‘template<class T> std::vector<dlib::matrix<float, 0, 1> > face_recognition_model_v1::compute_face_descriptor(const dlib::matrix<T, 0, 0, dlib::memory_manager_stateless_kernel_1<char>, dlib::row_major_layout>&, const std::vector<dlib::full_object_detection>&, int) const’
   81 |     std::vector<dlib::matrix<float, 0, 1>> compute_face_descriptor(
      |                                            ^~~~~~~~~~~~~~~~~~~~~~~
face_recognition_model_v1.h:81:44: note:   template argument deduction/substitution failed:
vision_module.cpp:111:87: note:   ‘dlib::cv_image<dlib::bgr_pixel>’ is not derived from ‘const dlib::matrix<T, 0, 0, dlib::memory_manager_stateless_kernel_1<char>, dlib::row_major_layout>’
  111 |     dlib::matrix<float, 0, 1> face_descriptor = face_rec_model.compute_face_descriptor(dlib_frame, shape, 1);
      |                                                 ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~^~~~~~~~~~~~~~~~~~~~~~
addshark@addshark-desktop:~/Desktop/addshark/MemoryRobot$ g++ -o test_vision vision_module.cpp $(pkg-config --cflags --libs opencv4) -ldlib -Wall -I.
